...
export function mouseoutLayer() {
    document.querySelectorAll('#layers .hover').forEach(el => el.classList.remove('hover'));
...
export function selectedLayer() {
    ...
    document.querySelectorAll('#layers .selected').forEach(el => el.classList.remove('selected'));
